...
def conv_to_num(knn_neigh, im):
    ...
    print 'knn prob: ', np.amax(knn_neigh.predict_proba(np.asarray(im).ravel())),
    return str(num[0])

def find_num(knn_neigh, knn_neigh_set, input_png, output_serve, output_score_1, output_score_2, output_set_1, output_set_2):
    ...
    return (conv_to_num(knn_neigh, im_serve),
            conv_to_num(knn_neigh, im1),
...
if __name__=='__main__':
    ...
    while (os.path.exists(input_frame_file) and index<=END_FRAME):
        ...
        num_serve, num_1,num_2, num_set1, num_set2 = find_num(knn_neigh, knn_neigh_set, input_frame_file, output_serve, output_score_1, output_score_2, output_set_1, output_set_2)
        num_1 = num_1.strip()
        num_2 = num_2.strip()
